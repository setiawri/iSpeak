...
namespace iSpeakWebApp.Models
{
    ...
    public class UserAccountRolesModel
    {
        ...
        [Display(Name = "View All Roles")]
        public bool UserAccounts_ViewAllRoles { get; set; }
        public static ModelMember COL_UserAccounts_ViewAllRoles = new ModelMember { Name = "UserAccounts_ViewAllRoles", Display = "View All Roles", LogDisplay = ActivityLogsController.editBooleanFormat("UserAccounts View All Roles") };
        ...
        [Display(Name = "Notes")]
        public string ClubSchedules_Notes { get; set; }
        public static ModelMember COL_ClubSchedules_Notes = new ModelMember { Name = "ClubSchedules_Notes", Display = "Notes", LogDisplay = ActivityLogsController.editStringFormat("ClubSchedules Notes") };

        [Display(Name = "Add")]
        public bool ClubSchedules_Add { get; set; }
        public static ModelMember COL_ClubSchedules_Add = new ModelMember { Name = "ClubSchedules_Add", Display = "Add", LogDisplay = ActivityLogsController.editBooleanFormat("ClubSchedules Add") };

        [Display(Name = "View")]
        public bool ClubSchedules_View { get; set; }
        public static ModelMember COL_ClubSchedules_View = new ModelMember { Name = "ClubSchedules_View", Display = "View", LogDisplay = ActivityLogsController.editBooleanFormat("ClubSchedules View") };
        ...
        [Display(Name = "Notes")]
        public string ClubClassOnlineLinks_Notes { get; set; }
        public static ModelMember COL_ClubClassOnlineLinks_Notes = new ModelMember { Name = "ClubClassOnlineLinks_Notes", Display = "Notes", LogDisplay = ActivityLogsController.editStringFormat("ClubClassOnlineLinks Notes") };

        [Display(Name = "Add")]
        public bool ClubClassOnlineLinks_Add { get; set; }
        public static ModelMember COL_ClubClassOnlineLinks_Add = new ModelMember { Name = "ClubClassOnlineLinks_Add", Display = "Add", LogDisplay = ActivityLogsController.editBooleanFormat("ClubClassOnlineLinks Add") };

        [Display(Name = "View")]
        public bool ClubClassOnlineLinks_View { get; set; }
        public static ModelMember COL_ClubClassOnlineLinks_View = new ModelMember { Name = "ClubClassOnlineLinks_View", Display = "View", LogDisplay = ActivityLogsController.editBooleanFormat("ClubClassOnlineLinks View") };

        [Display(Name = "Edit")]
        public bool ClubClassOnlineLinks_Edit { get; set; }
        public static ModelMember COL_ClubClassOnlineLinks_Edit = new ModelMember { Name = "ClubClassOnlineLinks_Edit", Display = "Edit", LogDisplay = ActivityLogsController.editBooleanFormat("ClubClassOnlineLinks Edit") };
